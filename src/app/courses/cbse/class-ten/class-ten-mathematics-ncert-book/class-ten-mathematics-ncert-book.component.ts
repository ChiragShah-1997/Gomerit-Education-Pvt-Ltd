...
@Component({
  selector: 'app-class-ten-mathematics-ncert-book',
  templateUrl: './class-ten-mathematics-ncert-book.component.html',
  styleUrls: ['./class-ten-mathematics-ncert-book.component.css']
})
export class ClassTenMathematicsNcertBookComponent implements OnInit {
