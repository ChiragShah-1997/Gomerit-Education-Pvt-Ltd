...
@Component({
  selector: 'app-class-nine-science-ncert-book',
  templateUrl: './class-nine-science-ncert-book.component.html',
  styleUrls: ['./class-nine-science-ncert-book.component.css']
})
export class ClassNineScienceNcertBookComponent implements OnInit {
